class GoodsController < ApplicationController
  ...
  def good_params
    params.require(:good).permit(:name, :explanation, :category_id, :brand, :condition_id, :prefecture_id, :derivery_day_id, :derivery_cost_id, :price, :user_id, :transaction_status_id, images_attributes: [:image, :_destroy, :id]).merge(user_id: current_user.id)
  end
